        ...
        <View style={styles.profileHeaderBackground}>
          <View style={styles.profileHeader}>
            <View style={styles.userInfo}>
              <Text style={styles.usernameText}>{fName} {lName}</Text>
            </View>
          </View>
          <View style={styles.profileOptions}>
            <View style={styles.userEmail}>
              <Text style={styles.userEmailText}>{authInfo.username}@gmail.com</Text>
            </View>
            <View style={styles.settingsBackground}>
              <TouchableOpacity
                ...
                underlayColor="#fff"
              >
                <Text style={styles.settingsOptionsText}>My Info</Text>
                <Icon
              ...
              <TouchableOpacity
                ...
                underlayColor="#fff"
              >
                <Text style={styles.settingsOptionsText}>Shipping Address</Text>
                <Icon
                  name="ios-arrow-forward"
                  size={24}
                  style={{ color: '#333', paddingRight: 30 }}
              ...
              <TouchableOpacity
                ...
                underlayColor="#fff"
              >
                <Text style={styles.settingsOptionsText}>Payment Methods</Text>
                <Icon
                  name="ios-arrow-forward"
                  size={24}
                  style={{ color: '#333', paddingRight: 30 }}
